...
<body>
  ...
  <div class="menu-container">
    ...
    <div class="list-group">
      ...
      <a href="cadastroAuditor.html" class="list-group-item list-group-item-action">
        <i class="fas fa-user-check"></i> Cadastrar Auditor
      </a>
      <a href="cadastroSetor.html" class="list-group-item list-group-item-action">
      ...
      <a href="relatorio.html" class="list-group-item list-group-item-action">
